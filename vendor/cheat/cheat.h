...
*/
__attribute__((__const__, __warn_unused_result__)) static size_t
cheat_mean(size_t const size, size_t const another_size)
{
...
*/
__attribute__((__nonnull__, __pure__, __warn_unused_result__)) static bool
cheat_compare(char const *const first, char const *const second)
{
    size_t index;
...
*/
__attribute__((__malloc__, __warn_unused_result__)) static void *
cheat_allocate_total(size_t const count, ...)
{
    va_list list;
    size_t index;
    size_t size = 0;
...
returns NULL and sets errno in case of a failure.
*/
__attribute__((__warn_unused_result__)) static void *
cheat_reallocate_array(void *const pointer, size_t const count, size_t const size)
{
...
{
    switch (outcome) {
    case CHEAT_SUCCESSFUL: return 0;
    case CHEAT_FAILED: return CHEAT_OFFSET;
    case CHEAT_EXITED: return CHEAT_OFFSET + 1;
    case CHEAT_CRASHED: return CHEAT_OFFSET + 2;
    case CHEAT_TIMED_OUT: return CHEAT_OFFSET + 3;
    case CHEAT_IGNORED: return CHEAT_OFFSET + 4;
    case CHEAT_SKIPPED: return CHEAT_OFFSET + 5;
    default: cheat_death("invalid outcome", outcome);
    }
}
...
{
    switch (status) {
    case 0: return CHEAT_SUCCESSFUL;
    case CHEAT_OFFSET: return CHEAT_FAILED;
    case CHEAT_OFFSET + 1: return CHEAT_EXITED;
    case CHEAT_OFFSET + 2: return CHEAT_CRASHED;
    case CHEAT_OFFSET + 3: return CHEAT_TIMED_OUT;
    case CHEAT_OFFSET + 4: return CHEAT_IGNORED;
    case CHEAT_OFFSET + 5: return CHEAT_SKIPPED;
    default: return CHEAT_CRASHED;
    }
}
...
cheat_initialize_string_array(struct cheat_string_array *const array)
{
    array->count    = 0;
    array->elements = NULL;
}
...
*/
__attribute__((__nonnull__)) static void
cheat_initialize_string_list(struct cheat_string_list *const list)
{
    list->count    = 0;
    list->capacity = 0;
    list->items    = NULL;
...
*/
__attribute__((__nonnull__)) static void
cheat_initialize_list(struct cheat_character_array_list *const list)
{
    list->count    = 0;
    list->capacity = 0;
    list->items    = NULL;
...
*/
__attribute__((__nonnull__)) static void
cheat_initialize_statistics(struct cheat_statistics *const statistics)
{
    statistics->run        = 0;
...
*/
__attribute__((__nonnull__)) static void
cheat_clear_string_list(struct cheat_string_list *const list)
{
    list->count    = 0;
    list->capacity = 0;
    free(list->items);
...
*/
__attribute__((__nonnull__)) static void
cheat_clear_list(struct cheat_character_array_list *const list)
{
    while (list->count > 0) free(list->items[--list->count].elements);
...
cheat_append_string_list(struct cheat_string_list *const list, char *const item)
{
    size_t count;
    ...
    if (list->count == list->capacity) {
        ...
        items =
            CHEAT_CAST(char **, cheat_reallocate_array(list->items, capacity, sizeof *list->items));
        if (items == NULL)
...
terminates the program in case of a failure.
*/
__attribute__((__nonnull__(1))) static void cheat_append_list(
    struct cheat_character_array_list *const list, char const *const buffer, size_t const size
)
{
    size_t count;
    char *elements;
...
cheat_hide(struct cheat_suite const *const suite, FILE const *const stream)
{
    ...
    case CHEAT_UNSAFE:
    case CHEAT_DANGEROUS: return stream == stdout || stream == stderr;
    case CHEAT_SAFE: return false;
    default: cheat_death("invalid harness", suite->harness);
    }
}
...
__attribute__((__nonnull__)) static void cheat_handle_outcome(struct cheat_suite *const suite)
{
    ...
    case CHEAT_TIMED_OUT:
        ...
        ++suite->tests.failed;
        break;
    case CHEAT_IGNORED: ++suite->tests.run;
    case CHEAT_SKIPPED: break;
    default: cheat_death("invalid outcome", suite->outcome);
    }
}
...
*/
__attribute__((__nonnull__)) static void
cheat_exit(struct cheat_suite *const suite, int const status)
{
    switch (suite->harness) {
    case CHEAT_UNSAFE: suite->outcome = CHEAT_EXITED; break;
    case CHEAT_DANGEROUS: longjmp(suite->environment, CHEAT_EXITED);
    case CHEAT_SAFE: exit(CHEAT_EXITED);
    default: cheat_death("invalid harness", suite->harness);
    }
}
...
terminates the program in case of a failure.
*/
__attribute__((__io__, __nonnull__)) static void
cheat_print_list(struct cheat_character_array_list const *const list)
{
    size_t index;
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_print_usage(struct cheat_suite const *const suite)
{
    bool strip         = false;
    ...
    char usage_format[] =
        CHEAT_BOLD "%s" CHEAT_RESET " [test or option] [another test or option] [...]";
    char option_strings[][80] = {
        ...
        CHEAT_BOLD "-n" CHEAT_RESET "  " CHEAT_BOLD "--noisy" CHEAT_RESET
                   "      Capture and display standard streams",
        CHEAT_BOLD "-p" CHEAT_RESET "  " CHEAT_BOLD "--plain" CHEAT_RESET
                   "      Present everything in plain text",
        CHEAT_BOLD "-s" CHEAT_RESET "  " CHEAT_BOLD "--safe" CHEAT_RESET
        ...
        CHEAT_BOLD "-v" CHEAT_RESET "  " CHEAT_BOLD "--version" CHEAT_RESET
                   "    Print version information",
        CHEAT_BOLD "-q" CHEAT_RESET "  " CHEAT_BOLD "--quiet" CHEAT_RESET
                   "      Do not capture standard streams",
        ""
    };

    switch (suite->style) {
    case CHEAT_PLAIN: strip = true;
    case CHEAT_COLORFUL:
        print_usage   = true;
        print_options = true;
        print_labels  = true;
    ...
    case CHEAT_MINIMAL:
        ...
        print_usage = true;
        break;
    default: cheat_death("invalid style", suite->style);
    }
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_print_tests(struct cheat_suite const *const suite)
{
    bool strip          = false;
    bool print_labels   = false;
    ...
    case CHEAT_COLORFUL:
        ...
        print_subtypes = true;
        break;
    case CHEAT_MINIMAL: strip = true; break;
    default: cheat_death("invalid style", suite->style);
    }
    ...
    for (index = 0; suite->units[index].type != CHEAT_TERMINATOR; ++index) {
        ...
        if (print_subtypes)
            ...
            case CHEAT_IGNORED_TEST: (void)fputs(" (ignored)", stdout); break;
            case CHEAT_SKIPPED_TEST: (void)fputs(" (skipped)", stdout);
            case CHEAT_NORMAL_TEST: break;
            default: cheat_death("invalid subtype", suite->style);
            }
        (void)fputc('\n', stdout);
    }
}
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_print_outcome(struct cheat_suite const *const suite)
{
    bool strip               = false;
    ...
    switch (suite->style) {
    case CHEAT_PLAIN: strip = true;
    case CHEAT_COLORFUL: print_outcome = true; break;
    case CHEAT_MINIMAL: break;
    default: cheat_death("invalid style", suite->style);
    }
    ...
    if (print_outcome) {
        ...
        switch (suite->outcome) {
        case CHEAT_SUCCESSFUL: outcome_string = successful_string; break;
        case CHEAT_FAILED: outcome_string = failed_string; break;
        case CHEAT_EXITED: outcome_string = exited_string; break;
        case CHEAT_CRASHED: outcome_string = crashed_string; break;
        case CHEAT_TIMED_OUT: outcome_string = timed_out_string; break;
        case CHEAT_IGNORED: outcome_string = ignored_string; break;
        case CHEAT_SKIPPED: outcome_string = skipped_string; break;
        default: cheat_death("invalid outcome", suite->outcome);
        }
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_print_separator(struct cheat_suite const *const suite)
{
    bool strip              = false;
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_print_summary(struct cheat_suite const *const suite)
{
    bool strip            = false;
    bool regular          = false;
    ...
    char long_successful_format[] =
        CHEAT_FOREGROUND_GREEN CHEAT_SIZE_FORMAT " successful" CHEAT_RESET;
    ...
    if (print_summary) {
        ...
        if (regular || any_successes) {
            ...
            (void
            )cheat_print(stdout, successful_format, 1, (CHEAT_SIZE_TYPE)suite->tests.successful);
        }
...
terminates the program in case of a failure.
*/
__attribute__((__io__, __nonnull__)) static void cheat_print_failure(
...
)
{
    ...
    char assertion_format[] = CHEAT_BOLD
        "%s:" CHEAT_SIZE_FORMAT ":" CHEAT_RESET " assertion in '" CHEAT_BOLD "%s" CHEAT_RESET
        "' failed: '" CHEAT_BOLD "%s" CHEAT_RESET "'\n"; /* Mind the line break. */

    switch (suite->style) {
    case CHEAT_PLAIN: strip = true;
    case CHEAT_COLORFUL: print_assertion = true; break;
    case CHEAT_MINIMAL: break;
    default: cheat_death("invalid style", suite->style);
    }
    ...
    if (print_assertion) {
        ...
        case CHEAT_DANGEROUS:
            buffer = CHEAT_CAST(
                char *, cheat_allocate_total(
                            6, strlen(assertion_format), strlen(file), CHEAT_INTEGER_LENGTH(line),
            ...
            if (cheat_print_string(
                    buffer, assertion_format, 4, file, (CHEAT_SIZE_TYPE)line, suite->test_name,
                    truncation
                )
                < 0)
        ...
        case CHEAT_SAFE:
            (void)cheat_print(
                suite->message_stream, assertion_format, 4, file, line, suite->test_name, truncation
            );
...
__attribute__((__warn_unused_result__)) static bool cheat_further(enum cheat_outcome const outcome)
{
    switch (outcome) {
    case CHEAT_SUCCESSFUL:
    case CHEAT_FAILED: return true;
    case CHEAT_EXITED:
    case CHEAT_CRASHED:
    case CHEAT_TIMED_OUT: return false;
    case CHEAT_IGNORED:
    case CHEAT_SKIPPED:
    default: cheat_death("invalid outcome", outcome);
    }
...
terminates the program in case of a failure.
*/
__attribute__((__io__, __nonnull__)) static void cheat_check(
    struct cheat_suite *const suite,
    bool const result,
    char const *const expression,
    char const *const file,
...
terminates the program in case of a failure.
*/
__attribute__((__io__)) static void
cheat_run_utilities(struct cheat_suite *const suite, enum cheat_subtype const subtype)
{
    size_t index;
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_run_coupled_test(struct cheat_suite *const suite, struct cheat_unit const *const unit)
{
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_isolate_test(struct cheat_suite *const suite, struct cheat_unit const *const test)
{
    ...
    do {
        ...
        FD_ZERO(&set);
        for (index = 0; index < channel_count; ++index) FD_SET(channels[index].reader, &set);
    ...
    */
    ...
    if (!CreateProcess(
            NULL, command, NULL, NULL, TRUE, NORMAL_PRIORITY_CLASS, NULL, NULL, &startup, &process
        )) /* There is CommandLineToArgvW(), but
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_run_hidden(struct cheat_suite *const suite, char const *const name)
{
    struct cheat_unit const *unit;
    DWORD pid;
    LPTSTR pipe;
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_run_specific(struct cheat_suite *const suite, struct cheat_unit const *const unit)
{
    int status;

    switch (suite->harness) {
    case CHEAT_SAFE: cheat_isolate_test(suite, unit); break;
    case CHEAT_DANGEROUS:
        ...
        if (status == 0)
            ...
            suite->outcome = cheat_decode_status(status);
        break;
    case CHEAT_UNSAFE: cheat_run_coupled_test(suite, unit); break;
    default: cheat_death("invalid harness", suite->harness);
    }
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_run_some(struct cheat_suite *const suite, struct cheat_string_list const *const names)
{
    size_t index;
...
*/
__attribute__((__io__, __nonnull__)) static void
cheat_run_suite(struct cheat_suite *const suite, struct cheat_string_list const *const names)
{
...
__attribute__((__io__, __nonnull__)) static void cheat_parse(struct cheat_suite *const suite)
{
    ...
    if (help
        && !(
            list || version /* No conflicting options. */
            || dangerous || eternal || noisy || safe || timed || unsafe || quiet
        ))
        cheat_print_usage(suite);
    else if (list
             && !(
                 help || version || dangerous || eternal || noisy || safe || timed || unsafe
                 || quiet
             ))
        cheat_print_tests(suite);
    else if (version
             && !(
                 help || list || dangerous || eternal || noisy || safe || timed || unsafe || quiet
             ))
        cheat_print_version();
    else if (!(help || list || version) && !(colorful && minimal) && !(colorful && plain)
             && !(minimal && plain) && !(dangerous && safe) && !(dangerous && unsafe)
             && !(noisy && quiet) && !(safe && unsafe) && !(eternal && timed)
...
#define CHEAT_COMMAS_9(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10) \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10
#define CHEAT_COMMAS_10(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11) \
...
#define CHEAT_COMMAS_16(                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17 \
)                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17
#define CHEAT_COMMAS_17(                                                            \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18 \
)                                                                                   \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18
#define CHEAT_COMMAS_18(                                                                 \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19 \
)                                                                                        \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19
#define CHEAT_COMMAS_19(                                                                      \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20 \
)                                                                                             \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20
#define CHEAT_COMMAS_20(                                                                           \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21 \
)                                                                                                  \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21
#define CHEAT_COMMAS_21(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22                                                                                   \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22
#define CHEAT_COMMAS_22(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23                                                                              \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23
#define CHEAT_COMMAS_23(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24                                                                         \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24
#define CHEAT_COMMAS_24(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25                                                                    \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25
#define CHEAT_COMMAS_25(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26                                                               \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26
#define CHEAT_COMMAS_26(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27                                                          \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27
#define CHEAT_COMMAS_27(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28                                                     \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28
#define CHEAT_COMMAS_28(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29                                                \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29
#define CHEAT_COMMAS_29(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30                                           \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30
#define CHEAT_COMMAS_30(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31                                      \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31
#define CHEAT_COMMAS_31(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32                                 \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32
#define CHEAT_COMMAS_32(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33                            \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33
#define CHEAT_COMMAS_33(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34                       \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34
#define CHEAT_COMMAS_34(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35                  \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35
#define CHEAT_COMMAS_35(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36             \
)                                                                                              \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36
#define CHEAT_COMMAS_36(                                                                       \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, \
...
#define CHEAT_COMMAS_89(                                                                           \
    ...
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20,     \
        ...
        x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, x51, x52, x53, x54, x55, x56,  \
        x57, x58, x59, x60, x61, x62, x63, x64, x65, x66, x67, x68, x69, x70, x71, x72, x73, x74,  \
        x75, x76, x77, x78, x79, x80, x81, x82, x83, x84, x85, x86, x87, x88, x89, x90
#define CHEAT_COMMAS_90(                                                                           \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20,     \
    x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, \
    x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, x51, x52, x53, x54, x55, x56, x57, x58, \
    x59, x60, x61, x62, x63, x64, x65, x66, x67, x68, x69, x70, x71, x72, x73, x74, x75, x76, x77, \
...
#define CHEAT_COMMAS_120(                                                                          \
    ...
    x78, x79, x80, x81, x82, x83, x84, x85, x86, x87, x88, x89, x90, x91, x92, x93, x94, x95, x96, \
    x97, x98, x99, x100, x101, x102, x103, x104, x105, x106, x107, x108, x109, x110, x111, x112,   \
    x113, x114, x115, x116, x117, x118, x119, x120, x121                                           \
)                                                                                                  \
    x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20,     \
        x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38,  \
        x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, x51, x52, x53, x54, x55, x56,  \
...
cheat_printed_length(char const *const format, va_list list)
{
...
CHEAT_UNWRAP(vfprintf)(FILE *const stream, char const *const format, va_list list)
{
    return vfprintf(stream, format, list);
}

__attribute__((__unused__)) static int
CHEAT_WRAP(vfprintf)(FILE *const stream, char const *const format, va_list list)
{
...
__attribute__((__unused__)) static int
CHEAT_UNWRAP(fprintf)(FILE *const stream, char const *const format, ...)
{
    va_list list;
    int result;
...
__attribute__((__unused__)) static int
CHEAT_WRAP(fprintf)(FILE *const stream, char const *const format, ...)
{
    va_list list;
    int result;
...
__attribute__((__unused__)) static int
CHEAT_UNWRAP(fputs)(char const *const message, FILE *const stream)
{
    return fputs(message, stream);
}

__attribute__((__unused__)) static int
CHEAT_WRAP(fputs)(char const *const message, FILE *const stream)
{
    int result;
...
__attribute__((__unused__)) static size_t CHEAT_UNWRAP(fwrite)(
    void const *const buffer, size_t const size, size_t const count, FILE *const stream
)
{
    return fwrite(buffer, size, count, stream);
}

__attribute__((__unused__)) static size_t CHEAT_WRAP(fwrite)(
    void const *const buffer, size_t const size, size_t const count, FILE *const stream
)
{
    if (cheat_hide(&cheat_suite, stream)) {
...
__attribute__((__unused__)) static ssize_t
CHEAT_UNWRAP(write)(int const fd, void const *const buffer, size_t const size)
{
    return write(fd, buffer, size);
}

__attribute__((__unused__)) static ssize_t
CHEAT_WRAP(write)(int const fd, void const *const buffer, size_t const size)
{
    FILE *stream;
