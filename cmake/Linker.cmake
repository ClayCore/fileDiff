macro(dev_configure_linker project_name)
  ...
  if(${USER_LINKER_OPTION_INDEX} EQUAL -1)
    message(STATUS " * using linker: '${USER_LINKER_OPTION}', supported: ${USER_LINKER_OPTION_VALUES}")
  endif()

  if(NOT dev_ENABLE_USER_LINKER)
    return()
  endif()
